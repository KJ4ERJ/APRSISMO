...
--------------------------------------------------------------------------------
-- Allows changing the currently active screen size.
-- Also re-sets viewWidth/Height based on the viewScale
...
function M:setScreenSize(width, height)
    ...
    self.viewWidth = width / self.viewScale
    self.viewHeight = height / self.viewScale
end
