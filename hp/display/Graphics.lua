...
function M:init(params)
	...
	--print("Graphics:init:"..tostring(self)..debug.traceback())
...
if MOAIGfxDevice.setPointSize then
    ...
    --deck:setRectCallback(function(i) print('Graphics:setRectCallback('..tostring(i)..')') Resizable:setRectCallback(i) end)
    --deck:setTotalRectCallback(function() print('Graphics:setTotalRectCallback('..tostring(i)..')') Resizable:setTotalRectCallback() end)
