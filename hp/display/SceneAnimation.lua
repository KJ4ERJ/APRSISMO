...
--------------------------------------------------------------------------------
-- Display a pop-up overlay (doesn't dim main scene)
--------------------------------------------------------------------------------
function M.overlay(currentScene, nextScene, params)
...
--------------------------------------------------------------------------------
-- Close the pop-up display without delays or animation effects. <br>
-- Valid only for scene that displays pop-up.
--------------------------------------------------------------------------------
function M.popDown(currentScene, nextScene, params)
    local layer = nextScene:getChildByName(POPUP_LAYER)
	return Animation():callFunc(function() nextScene:removeChild(layer)end)
end
