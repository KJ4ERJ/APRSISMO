...
M.SCENE_CLOSING = "sceneClosing"
M.SCENE_RESUMING = "sceneResuming"
...
--print('Event:init:'..eventType..'('..tostring(self)..') stoped:'..tostring(self.stoped)..' from:'..tostring(info.short_src)..':'..tostring(info.currentline))
end
