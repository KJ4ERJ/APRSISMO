...
function M:initInternal(params)
    ...
    self._maxScrollingForceX = 200
    self._maxScrollingForceY = 200
...
function M:touchDownHandler(e)
	...
	self._touchStartX = e.x
	self._touchStartY = e.y
	self._touchLastX = e.x
	self._touchLastY = e.y
...
if e.moveX ~= e.x-self._touchLastX or e.moveY ~= e.y-self._touchLastY then
--	print(string.format('Scroller:touchMoveHandler:Touch %d %d ~= Delta %d %d',e.moveX,e.moveY,e.x-self._touchLastX,e.y-self._touchLastY))
	moveX, moveY = e.x-self._touchLastX, e.y-self._touchLastY
end
	self._touchLastX = e.x
	self._touchLastY = e.y
...
--if e.moveY ~= moveY then
--	print(string.format('Scroller:touchMoveHandler:Touch %d %d Actual:%d %d',e.moveX,e.moveY,moveX,moveY))
--end
--print(string.format('Scroller:touchMoveHandler:Delta %d %d Total %d %d',e.x-self._touchLastX,e.y-self._touchLastY,e.x-self._touchStartX,e.y-self._touchStartY))
