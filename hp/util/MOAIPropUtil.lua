...
function M.getWidth(prop)
	...
	if xMin == nil or xMax == nil then print("moaiPropUtil:getWidth: xMin:"..tostring(xMin).." yMin:"..tostring(yMin).." zMin:"..tostring(zMin).." xMax:"..tostring(xMax).." yMax:"..tostring(yMax).." zMax:"..tostring(zMax)) end
	if xMax == nil or xMin == nil then return 0 end
...
function M.getHeight(prop)
    local xMin, yMin, zMin, xMax, yMax, zMax = prop:getBounds()
	if yMin == nil or yMax == nil then print("moaiPropUtil:getHeight: xMin:"..tostring(xMin).." yMin:"..tostring(yMin).." zMin:"..tostring(zMin).." xMax:"..tostring(xMax).." yMax:"..tostring(yMax).." zMax:"..tostring(zMax)) end
	if yMax == nil or yMin == nil then return 0 end
